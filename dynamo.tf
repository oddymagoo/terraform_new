#   DynamoDB
##
#This table does not appear to be used. But including in build as it was there.
resource "aws_dynamodb_table" "hazchat-3-app-content-table" {
  name         = "hazchat-3-app-content-table-${var.environment}"
  billing_mode = "PAY_PER_REQUEST"
  #deletion_protection_enabled = "true" #disabled for DEV, UAT, SIT
  hash_key = "id"
...
resource "aws_dynamodb_table" "hazchat-3-employee-table" {
  name         = "hazchat-3-employee-table-${var.environment}"
  billing_mode = "PAY_PER_REQUEST"
  #deletion_protection_enabled = "true" #disabled for DEV, UAT, SIT
  hash_key = "id"
...
resource "aws_dynamodb_table" "hazchat-3-person-table" {
  name         = "hazchat-3-person-table-${var.environment}"
  billing_mode = "PAY_PER_REQUEST"
  #deletion_protection_enabled = "true" #disabled for DEV, UAT, SIT
  hash_key = "id"
...
resource "aws_dynamodb_table" "hazchat-3-swms-content-table" {
  name         = "hazchat-3-swms-content-table-${var.environment}"
  billing_mode = "PAY_PER_REQUEST"
  #deletion_protection_enabled = "true" #disabled for DEV, UAT, SIT
  hash_key = "id"
...
resource "aws_dynamodb_table" "hazchat-3-table" {
...
###
# Dummy data is part of the dynamodb.tf file
###
